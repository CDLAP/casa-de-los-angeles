    ...
    <AnimatePresence>
      {show && (
        <motion.button
          ...
          whileTap={{ scale: 0.96 }}
          className="fixed bottom-5 right-5 sm:bottom-7 sm:right-7 z-40 group bg-gold text-charcoal shadow-2xl shadow-gold/30 px-5 py-3.5 sm:px-7 sm:py-4 flex items-center gap-3 font-sans text-xs sm:text-sm uppercase tracking-[0.2em] font-medium hover:bg-gold-light transition-colors duration-300"
