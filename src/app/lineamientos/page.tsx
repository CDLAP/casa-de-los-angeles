...
import { MapPin, Clock, DollarSign, ShoppingBag, Palette, Lightbulb, Sparkles, Phone, CheckCircle, XCircle, ArrowLeft } from 'lucide-react'

export default function LineamientosPage() {
  return (
    <div className="min-h-screen bg-cream">
      {/* Header */}
      <div className="bg-emerald text-white px-6 md:px-10 py-8 md:py-12">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            Volver a Casa de los Ángeles
          </Link>
          <h1 className="font-serif text-3xl md:text-4xl">Mercado</h1>
          <p className="text-white/80 text-base mt-2">Lineamientos para Expositores</p>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="text-center border-b border-gold/20 pb-8">
            <p className="text-charcoal-50 text-lg leading-relaxed">
              Gracias por tu interés en formar parte del Mercado de Casa de los Ángeles. 
